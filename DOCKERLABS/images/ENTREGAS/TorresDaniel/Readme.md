...
| nmap --min-rate 5000 -p- -sS -sV        | Escaneo de puertos y servicios.      | Escaneo SYN, todos los puertos, detección de servicios. | nmap -T4 -A                          | nmap -Pn -p 22,80          | nmap --script vuln |
